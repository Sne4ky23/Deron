...
export const Benefits: React.FC = () => {
  const benefits = [
    {
      title: 'Sin apps',
      description: 'El cliente no necesita instalar nada. Solo acercar el móvil.',
    },
    {
      title: 'Configuración en 2 minutos',
      description: 'Programamos el NFC con tu enlace de Google Maps.',
    },
    {
      title: 'Diseño personalizado',
      description: 'Con el logo y la identidad de tu negocio.',
    },
    {
      title: 'Más reseñas',
      description: 'Facilita que tus clientes valoren tu negocio.',
    },
  ];
