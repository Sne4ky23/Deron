...
export const Benefits: React.FC = () => {
  const benefits = [
    ...
    },
    {
      ...
      title: 'NFC + Código QR',
      description:
        'Chip contactless de lectura ultrarrápida combinado con un código QR grabado en alta resolución para compatibilidad universal con cualquier smartphone.',
    },
    {
      num: '03',
      tag: 'LLAVE EN MANO',
      ...
      description:
        'Entregamos el stand 100% configurado y vinculado a tu negocio. Sacar de la caja, situar en tu mostrador o mesa, y empezar a recibir valoraciones.',
    },
    {
      num: '04',
      ...
      description:
        'Estructura técnica sólida en acabado negro mate antirreflejos. Diseñado para soportar el uso diario intensivo, salpicaduras y limpieza continua.',
    },
  ];
