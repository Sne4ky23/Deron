    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto py-4">
        ...
        <motion.h1
          ...
          className="font-hero text-[clamp(44px,8vw,88px)] font-bold tracking-[0.18em] text-[#111111] uppercase leading-none select-none pl-[0.18em] max-w-full overflow-hidden"
        >
          DERON
        </motion.h1>
